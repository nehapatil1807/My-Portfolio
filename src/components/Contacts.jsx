  ...
  return (
    <div>
      <section id="contact" className="contact-container">
        ...
        <br />
        <p>
          If you'd like to connect, feel free to reach out via email or follow
          me on social media.
        </p>
        <div className="contact-buttons">
          <a href="https://mail.google.com/mail/?view=cm&to=nehaspatil2002@gmail.com" className="btn contact-btn">
            <img
              src="https://www.pngkey.com/png/detail/14-143562_gmail-logo-png-gmail-logo-black-and-white.png"
              alt=""
